...
import com.song.makeushifive.src.main.notification.NotificationInfo;
...
//        name+=".png";
        profileUrlNickName = sSharedPreferences.getString("nickname",null);
        profileUrlNickName+=".png";

        StorageReference spaceRef = storageRef.child(profileUrlNickName);
    ...
    private void getProfileUrlFromFireBase() throws JSONException {
        ...
        StorageReference reference = storage.getReference().child(profileUrlNickName);
